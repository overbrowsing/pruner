...
- **Minified**: [Available via pruner.min.js on unpkg.](https://unpkg.com/prunerjs@1.1.5/dist/pruner.min.js)
...
```html
<script async src="https://unpkg.com/prunerjs@1.1.5/dist/pruner.min.js"></script>
```
